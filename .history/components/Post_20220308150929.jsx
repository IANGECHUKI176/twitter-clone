    ...
    >
      ...
      <div className='flex flex-col space-y-2 w-full'>
        <div className={`flex ${!postPage && "justify-between"}`}>
          {postPage && (
            <img src={post?.userImg} className='h-11 w-11 rounded-full mr-4' alt="'/>
          )}
          <div className='#6e767d'>
            <div className='inline-block group'>
              ...
              <span
                className={`text-sm sm:text-[15px] opacity-50 ml-[10px]${
                  !postPage && "ml-1.5"
                }`}
              >
                @{post?.tag}
            ...
            <span className='hover:underline text-sm sm:text-[15px]'>
              {moment(post?.timestamp?.seconds * 1000).fromNow()}
            </span>
            {!postPage && (
          ...
          <div className='icon group shink-0 ml-auto'>
